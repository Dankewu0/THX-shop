...
namespace thxshop
{
    public partial class PC : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            {
                connection.Open();
                SqlCommand cmd = new SqlCommand("INSERT INTO pc (Тип, Компания, Название, АдресМагазина, Наличие) Values (@Тип, @Компания, @Название, @АдресМагазина, @Наличие)", connection);
